...
public class DisplayStockListData {
    ...
    public void DisplayData(){
        StockOrdersModel currentEditSelectedItem = stockDatabaseController.allStockItems.get(adminView.getLstStockEditDisplay().getSelectedIndex()); // Store selected district into a District array object
        ...
        // Display the correct AirBnB details on the Main Form in the text boxes
    ...
    public void DisplayViewData(){
        StockOrdersModel currentViewSelectedItem = stockDatabaseController.allStockItems.get(adminView.getLstDisplayStock().getSelectedIndex()); // Store selected district into a District array object
